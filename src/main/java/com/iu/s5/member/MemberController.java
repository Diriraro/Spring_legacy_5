...
public class MemberController {
	 ...
	 * ModelAndView mv = new ModelAndView();
	 * 
	 * int result = memberService.memberIdCheck(memberVO); mv.addObject("result",
	 * result); mv.setViewName("common/ajaxResult");
	 * 
	 * return mv; }
	 */	
...
//		model.addAttribute("cId", cId);
	...
	public String fileDelete(HttpSession session,String id,Model model)throws Exception{
